...
const AppointmentForm = () => {
  ...
  // Services are used directly in the select options below
...
*Location:* New Town, Kolkata`;
      ...
      const whatsappNumber = '919051864455'; // Hospital WhatsApp number
      ...
      setSubmitStatus({
        type: 'success',
        message: 'Appointment request sent to WhatsApp! Please complete sending the message to confirm your appointment.'
      });
      ...
      setSubmitStatus({
        type: 'error',
        message: 'Failed to create appointment request. Please try again.'
      });
    } finally {
